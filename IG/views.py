...
def edit_profile(request):
    ...
    return render(request, 'setup-profile.html',{"form": form})
...
def other_profile(request,id):
    ...
    followercount=len(followers)
    return render(request, 'profile2.html',{"profile_user": profile_user,"posts":posts,"followingcount":followingcount,"followercount":followercount})
